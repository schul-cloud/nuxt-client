<template>
  <div class="impressum-container">
    ...
    <p>
      ...
      </base-link>) durchgeführt wird. durchgeführt und durch das Bundesministerium für
      Bildung und Forschung (BMBF) gefördert wird (mehr Informationen finden Sie
      unter:
      <base-link
        href="https://hpi.de/schul-cloud"
        target="_blank"
      >
        https://hpi.de/schul-cloud
      </base-link>). Die Inhalte der HPI Schul-Cloud stellen keine offiziellen
      ...
      ist eine kommerzielle Verbreitung der über die HPI Schul-Cloud verfügbaren
      Inhalte ausdrücklich untersagt, außer diese sind ausdrücklich
